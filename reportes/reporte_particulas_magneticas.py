...
class ReporteParticulasMagneticas:
    ...
    def extraer_datos_proyecto(self) -> Dict[str, Any]:
        ...
        if 'datos_proyecto' in st.session_state:
            ...
            # Generar número de informe para partículas magnéticas (offset 2)
            ...
            numero_informe = generar_numero_informe(numero_orden, consecutivo_inicial, year, 2)
